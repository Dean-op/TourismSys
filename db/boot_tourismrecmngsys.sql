...
CREATE TABLE `hotelinfo` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1779615604015 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='酒店信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `restaurantinfo` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='餐厅信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `scenicinfo` (
  ...
  `merchantname` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '供应商名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb3 ROW_FORMAT=DYNAMIC COMMENT='景点信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-24 18:08:34
