	...
	<div class="list" :style='{"margin":"20px 0 0 0","flex":"1"}'>
		...
		<div class="list2 index-pv1" :style='{"border":"2px solid #bad399","padding":"20px 0px 0 0px","overflow":"hidden","borderRadius":"8px","background":"#fff","width":"100%","height":"auto"}'>
			<div :style='{"cursor":"pointer","margin":"0 0 20px 2%","borderRadius":"10px","flexWrap":"wrap","background":"#fff","display":"flex","width":"48%","fontSize":"0","float":"left","height":"150px"}' v-for="(item, index) in dataList" :key="index" @click="toDetail(item)" class="list-item animation-box">
				<div class="item-info" :style='{"padding":"12px","margin":"0 20px 0 40px","overflow":"hidden","borderRadius":"8px","background":"#FAFFE6","width":"calc(100% - 60px)","position":"relative","float":"right","height":"130px"}'>
					<div :style='{"padding":"0 10px","lineHeight":"24px","fontSize":"16px","color":"#333","fontWeight":"bold"}' class="title">{{item.mudedi}}</div>
					<div :style='{"padding":"0 10px","lineHeight":"24px","fontSize":"14px","color":"#666"}' class="time">出发时间：{{item.starttime}}</div>
					<div :style='{"padding":"0 10px","lineHeight":"24px","fontSize":"14px","color":"#666"}' class="duration">预计天数：{{item.duration}}天</div>
					<div :style='{"padding":"0 10px","lineHeight":"24px","fontSize":"14px","color":"#666","overflow":"hidden","textOverflow":"ellipsis","whiteSpace":"nowrap"}' class="route">路线：{{item.route}}</div>
					<div v-if="item.price" :style='{"padding":"12px","color":"#f00","top":"0","textAlign":"center","width":"auto","lineHeight":"24px","fontSize":"14px","position":"absolute","right":"0"}' class="price"><span :style='{"fontSize":"12px"}'>￥</span>{{item.price}}</div>
				</div>
			</div>
		</div>
	</div>
