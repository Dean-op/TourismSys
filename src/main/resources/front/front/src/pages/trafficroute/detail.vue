	...
	<div class="detail-preview" :style='{"width":"1200px","padding":"0 0 20px","margin":"0px auto","position":"relative","background":"none"}'>
		<div class="attr" :style='{"border":"2px solid #bad399","padding":"20px","margin":"20px 0 0 0","overflow":"hidden","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","position":"relative","justifyContent":"space-between","height":"auto"}'>
			...
			<div class="info" :style='{"minHeight":"570px","padding":"0 20px 20px","margin":"0px","borderRadius":"8px","background":"#f9f9f9","width":"600px","height":"auto","order":"2"}'>
                ...
                <div v-if="detail.guideid" :style='{"borderTop":"1px solid #eee","margin":"20px 0 0 0","padding":"20px 0 0 0"}'>
                    <div :style='{"fontSize":"18px","color":"#4E8531","fontWeight":"bold","marginBottom":"15px"}'>本路线推荐导游：{{detail.guidename}}</div>
                    <el-button type="primary" size="large" @click="bookingVisible = true" :style='{"background":"#bad399","border":"none","width":"200px","height":"50px","fontSize":"18px","borderRadius":"8px"}'>在线预约导游</el-button>
                </div>
                <div v-else :style='{"marginTop":"20px","color":"#999"}'>
                    暂无推荐导游
                </div>
			</div>
		</div>
    ...
    <el-dialog title="预约导游" :visible.sync="bookingVisible" width="500px">
      <el-form :model="bookingForm" label-width="100px">
        ...
        <el-form-item label="预约天数">
          <el-input-number v-model="bookingForm.days" :min="1" style="width: 100%;"></el-input-number>
        </el-form-item>
    ...
    methods: {
      ...
      submitBooking() {
        ...
        const params = {
          ...
          amount: 0, // 后端会自动根据导游价格计算，或者在这里计算
