	...
	<div class="main-content">
		...
		<template v-if="showFlag">
			...
			<el-table class="tables" :stripe='false'
				...
				v-if="isAuth('restaurantreserve', '查看')" :data="dataList" v-loading="dataListLoading"
				...
				<el-table-column :resizable='true' :sortable='false' prop="ispay" label="是否支付">
					<template slot-scope="scope">
						...
						<el-button v-if="scope.row.ispay != '已支付' && isAuth('restaurantreserve', '支付')" type="text" size="small"
				...
				<el-table-column width="300" label="操作">
					<template slot-scope="scope">
						<el-button
							...
							v-if="isAuth('restaurantreserve', '查看')" type="success" size="mini"
