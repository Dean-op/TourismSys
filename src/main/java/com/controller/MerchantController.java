...
public class MerchantController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		if(u.getSfsh() != null) {
			if("待审核".equals(u.getSfsh())) {
				return R.error("您的商家资质正在审核中，请耐心等待管理员审核！");
			}
			if("否".equals(u.getSfsh()) || "已拒绝".equals(u.getSfsh())) {
				return R.error("您的商家资质审核未通过，原因：" + (StringUtils.isNotBlank(u.getShhf()) ? u.getShhf() : "无"));
			}
		}
    ...
    public R page(@RequestParam Map<String, Object> params,MerchantEntity merchant,
		...
		if(tableName.equals("merchant")) {
			merchant.setMerchantusername((String)request.getSession().getAttribute("username"));
		}
