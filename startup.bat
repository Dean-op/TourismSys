...
echo - User Front Client: http://localhost:8082
echo - Admin & Merchant Backend: http://localhost:8081
echo.
echo [Notice] Please KEEP the three popped-up command windows running.
