...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', 'admin', '管理员', '系统管理员', '男', '13800000000', 'admin@tourism.com', NULL, '2025-12-09 18:32:16');
...
CREATE TABLE `chat`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1779183752669 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '在线客服' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of chat
-- ----------------------------
INSERT INTO `chat` VALUES (1779116263952, '2026-05-18 22:57:44', 1678358276062, 1, '你好', '您好！我是旅游推荐客服，若您有目的地、预算、偏好（如自然风光/人文历史）等需求，可随时告知，我会快速为您推荐合适的旅游方案~', 1);
INSERT INTO `chat` VALUES (1779160868574, '2026-05-19 11:21:08', 1678358276062, 1, '我在济南玩两天，预算只有500，帮我规划路线', '第一天：趵突泉（40元）→大明湖（免费）→曲水亭街（免费），吃油旋甜沫；第二天：千佛山（30元）→黑虎泉（免费）→宽厚里（平价小吃）。住经济型酒店（约200元），公交出行，总预算500内。', 1);
INSERT INTO `chat` VALUES (1779182063304, '2026-05-19 17:14:23', 1678358276062, 1, '帮我找一个在烟台的旅游路线', '烟台3日路线：D1游蓬莱阁（仙境文化地标）；D2烟台山（历史建筑+无敌海景）+滨海路漫步；D3养马岛骑行环岛（海岛风光）。兼顾自然与人文，轻松惬意。', 1);
INSERT INTO `chat` VALUES (1779183752669, '2026-05-19 17:42:32', 1678358276062, 1, '帮我推荐一下济南的美食', '济南必尝美食：油旋外酥内软带葱香；糖醋鲤鱼酸甜酥脆造型别致；把子肉肥而不腻配米饭绝搭；甜沫咸香暖胃是早餐标配。这些本地特色，值得一试。', 1);
...
CREATE TABLE `dictionary`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '字典' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `discusshotelinfo`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1779116653003 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '酒店评论' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `discusshotelinfo` VALUES (1779116653003, '2026-05-18 23:04:12', 51, 1, '', NULL, '666', NULL);
...
CREATE TABLE `discussrestaurantinfo`  (
  ...
  `reply` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '回复内容',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 109 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '餐厅预订评论' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1763546085978 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '景点信息评论表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 108 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '交通路线评论表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 108 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '旅游攻略评论表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1753414904980 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '反馈意见' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '导游' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of guide
-- ----------------------------
INSERT INTO `guide` VALUES (21, '2025-12-09 18:32:15', 'guide1', '123456', '王导游', '18600000000', '370102199001010011', 'upload/guide_avatar1.jpg', '持证导游', '泉城历史,趵突泉,大明湖', 300, '通过');
...
CREATE TABLE `guideorder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1779161396586 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '导游预约' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of guideorder
-- ----------------------------
INSERT INTO `guideorder` VALUES (31, '2025-12-09 18:32:15', 1678358276062, '1', 21, 'guide1', '王导游', '2025-08-10', 1, 300, '已完成', '济南市区一日讲解');
INSERT INTO `guideorder` VALUES (1779115463347, '2026-05-18 22:44:22', 1678358276062, '1', 21, 'guide1', '王导游', '2026-05-19', 1, 300, '已完成', '');
INSERT INTO `guideorder` VALUES (1779161396586, '2026-05-19 11:29:56', 1678358276062, '1', 21, 'guide1', '王导游', '2026-05-19', 35, 10500, '已取消', '没空');
...
CREATE TABLE `hotelinfo`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 58 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '酒店信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of hotelinfo
-- ----------------------------
INSERT INTO `hotelinfo` VALUES (51, '2025-12-09 18:32:15', '济南索菲特银座大饭店', '星级酒店', '济南市历下区泺源大街66号', '豪华套房', 880, '0531-86068888', '位于泺源大街，紧邻泉城广场，可俯瞰泉城美景。提供法式浪漫与齐鲁文化的融合体验，交通便利。', 'upload/hotel1.jpg', 128, 5, '2026-05-19 11:24:23', 522, '老牌五星级酒店，地处商业中心，服务周到。', 5.0, 'admin', '管理员');
INSERT INTO `hotelinfo` VALUES (52, '2025-12-09 18:32:15', '泉城大酒店', '星级酒店', '济南市历下区南门大街2号', '商务房', 450, '0531-86921911', '紧邻趵突泉和大明湖，地理位置极佳。提供地道的鲁菜早餐，是游览泉城的理想下榻之所。', 'upload/hotel2.jpg', 96, 3, '2026-05-18 23:05:54', 360, '位置核心，性价比高，设施完备。', 10.0, 'admin', '管理员');
...
CREATE TABLE `hotelreserve`  (
  ...
  `merchantname` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '供应商名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1779116750948 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '酒店预订' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `hotelreserve` VALUES (1779115944003, '2026-05-18 22:52:23', '济南索菲特银座大饭店', '星级酒店', '济南市历下区泺源大街66号', '豪华套房', 880, '2026-05-18 22:52:20', '', '1', '张三', '18154541454', '已支付', 51, 0.0, NULL, '已评价', '666666', 'upload/1678358274781.jpg', 'admin', '管理员');
INSERT INTO `hotelreserve` VALUES (1779116750948, '2026-05-18 23:05:50', '泉城大酒店', '星级酒店', '济南市历下区南门大街2号', '商务房', 450, '2026-05-18 23:05:44', '', '1', '张三', '18154541454', '已支付', 52, 10.0, '666', '已评价', NULL, 'upload/1678358274781.jpg', 'admin', '管理员');
...
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '供应商' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `news`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 132 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '公告信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `restaurantinfo`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 78 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '餐厅信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of restaurantinfo
-- ----------------------------
INSERT INTO `restaurantinfo` VALUES (71, '2025-12-09 18:32:15', '聚丰德(经五路店)', '济南市市中区经五路11号', '11:00-21:00', 120, 0, '济南著名的老字号鲁菜馆，招牌菜有九转大肠、糖醋鲤鱼、爆三样。传承鲁菜精髓，口味地道。', 'upload/restaurant1.jpg', 215, 12, '2026-05-19 17:10:15', 724, '正宗鲁菜体验，老字号品质保证。', 6.0, 'admin', '管理员', '0531-86012345');
INSERT INTO `restaurantinfo` VALUES (72, '2025-12-09 18:32:15', '金春禧', '济南市历下区泉城路26号', '10:30-21:30', 80, 0, '现代精致鲁菜与地方特色融合，环境优雅。主打禧味排骨、传统鲁菜，适合亲友聚会。', 'upload/restaurant2.jpg', 189, 15, '2026-05-18 23:11:28', 548, '精致鲁菜，口味丰富，环境舒适。', 6.0, 'admin', '管理员', '0531-86054321');
...
CREATE TABLE `restaurantreserve`  (
  ...
  `merchantname` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '供应商名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1779117087000 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '餐厅预订' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `restaurantreserve` VALUES (1779117041850, '2026-05-18 23:10:41', '聚丰德(经五路店)', '济南市市中区经五路11号', 0, '2026-05-18 23:10:40', '', '1', '张三', '18154541454', '未支付', 71, 0.0, NULL, '待审核', NULL, 'upload/1678358274781.jpg', 'admin', '管理员');
INSERT INTO `restaurantreserve` VALUES (1779117087000, '2026-05-18 23:11:26', '金春禧', '济南市历下区泉城路26号', 0, '2026-05-18 23:11:25', '', '1', '张三', '18154541454', '未支付', 72, 0.0, NULL, '待审核', NULL, 'upload/1678358274781.jpg', 'admin', '管理员');
...
CREATE TABLE `scenicinfo`  (
  ...
  `merchantname` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '供应商名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '景点信息' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of scenicinfo
-- ----------------------------
INSERT INTO `scenicinfo` VALUES (31, '2025-12-09 18:32:15', '漓江景区', '桂林市阳朔县阳朔镇抗战路6号', 'AAAAA', 210, '0773-8822666', '08:00-17:00（冬季08:30-16:30）', '世界自然遗产，以“山青、水秀、洞奇、石美”四绝闻名。核心景点包括象鼻山、九马画山、黄布倒影等。可乘竹筏漂流（230元）体验“百里漓江，百里画廊”，春季烟雨漓江最美，秋季观红叶，适合摄影与休闲', 'upload/scenic1.jpg', 329, 15, '2026-05-19 17:39:14', 1301, '广西旅游核心，世界自然遗产，建议安排1-2天游览', 8.0, 'nanning_travel', '南宁文旅集团有限公司');
...
CREATE TABLE `storeup`  (
  ...
  `remark` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1779173067651 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '收藏表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `storeup` VALUES (1779173067651, '2026-05-19 14:44:26', 18, 31, 'scenicinfo', '漓江景区', 'upload/scenic1.jpg', '1', NULL, NULL);
...
CREATE TABLE `ticketreserve`  (
  ...
  `merchantname` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '供应商名称',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1779183552755 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '门票预订' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ticketreserve` VALUES (1779183552755, '2026-05-19 17:39:12', '漓江景区', '桂林市阳朔县阳朔镇抗战路6号', 210, 'AAAAA', '2026-05-20 00:00:00', '', '1', '张三', '18154541454', '未支付', 31, 0.0, NULL, '待审核', NULL, 'upload/1678358274781.jpg', 'nanning_travel', '南宁文旅集团有限公司');
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES (12, 1678358276062, '1', 'users', '用户', 'bd5b95ml6zxk17ncigxdzt7ny5clpv7y', '2026-05-18 22:38:16', '2026-05-19 18:37:56');
INSERT INTO `token` VALUES (13, 21, 'guide1', 'guide', '导游', 'jhdhz90v0vxysifukd6zjphwrthwli6v', '2026-05-18 22:39:13', '2026-05-19 12:30:14');
INSERT INTO `token` VALUES (14, 1, 'admin', 'admin', '管理员', 'tnjrbaf7f8ordd93leezu1torjtekjye', '2026-05-18 22:42:30', '2026-05-24 15:38:35');
INSERT INTO `token` VALUES (15, 18, '账号8', 'users', '用户', 's811ws7pmxqmv45zztrvba2dduod77t9', '2026-05-19 14:16:19', '2026-05-19 15:16:19');
...
CREATE TABLE `tourplan`  (
  ...
  `name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '姓名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1678358426134 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '旅游规划' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `trafficroute`  (
  ...
  `content` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '路线简介',
  `guideid` bigint(0) NULL DEFAULT NULL COMMENT '导游ID',
  `guideusername` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '导游账号',
  `guidename` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '导游姓名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 93 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '交通路线' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of trafficroute
-- ----------------------------
INSERT INTO `trafficroute` VALUES (91, '2025-12-09 18:32:15', '济南站-大明湖-趵突泉 泉城观光专线', '景区接驳车', '济南火车站', '趵突泉东门', '约8公里', '<p>专线连接济南核心景点，途径大明湖、芙蓉街、泉城广场。每15分钟一班，是游客游览市区的首选方式。</p>', 'upload/traffic1.jpg', '泉城游览首选，直达各大核心景点。', 21, 'guide1', '王导游');
INSERT INTO `trafficroute` VALUES (92, '2025-12-09 18:32:15', '济南西站-经十路-千佛山 旅游快线', '公交出行', '济南西站', '千佛山风景区', '约15公里', '<p>从高铁站直达南部景区，全程走经十路，线路快捷。运营时间：06:00-21:00。</p>', 'upload/traffic2.jpg', '高铁站直达景区，高效便捷。', 22, 'guide2', '李导游');
INSERT INTO `trafficroute` VALUES (93, '2025-12-09 18:32:15', '济南市区-红叶谷 自驾路线', '自驾路线', '济南市区', '红叶谷景区', '约30公里', '<p>沿省道103线向南行驶，沿途风景优美，路况良好。秋季红叶满山时是最佳自驾时段。</p>', 'upload/traffic3.jpg', '适合周末家庭出游，感受自然风光。', 21, 'guide1', '王导游');
...
CREATE TABLE `travelguide`  (
  ...
  `content` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '简介',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 102 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '旅游攻略' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1678358276062 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `weather`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '天气预报' ROW_FORMAT = DYNAMIC;
